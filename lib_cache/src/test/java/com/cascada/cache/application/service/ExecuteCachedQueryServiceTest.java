 ...
 */
class ExecuteCachedQueryServiceTest {
    ...
    private ExecuteCachedQueryService useCase(SafetyRuleRegistry registry, QueryExecutorPort spark) {
        ...
        return new ExecuteCachedQueryService(registry, CacheConfiguration.defaults(),
    ...
    void aSafetyBypassRunsThePhysicalSqlDirectlyAndReportsNotCached() {
        ...
        ExecuteCachedQueryService.Result result = useCase(alwaysBypass, spark).execute(canonical());
    ...
    void aSafeQueryGoesThroughTheCacheEngineAndReportsCached() {
        ...
        ExecuteCachedQueryService.Result result = useCase(neverBypass, spark).execute(canonical());
